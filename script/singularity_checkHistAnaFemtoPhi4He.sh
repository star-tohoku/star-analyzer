#!/bin/bash
# Run checkHistAnaFemtoPhi4He.C inside singularity.
# Usage: ./script/singularity_checkHistAnaFemtoPhi4He.sh <root_file> <mainconf_path>
...
rm -f "$PROJECT_ROOT_REAL"/common/macro/checkHistAnaFemtoPhi4He_C.* 2>/dev/null
...
root4star -b -q 'analysis/run_checkHistAnaFemtoPhi4He.C("$ROOT_FILE_REAL","$ANA_NAME","$MAINCONF_REAL")'
EOF
)
