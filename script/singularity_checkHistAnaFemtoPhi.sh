...
rm -f "$PROJECT_ROOT_REAL"/common/macro/checkHistAnaFemtoPhi_C.* 2>/dev/null
...
root4star -b -q 'analysis/run_checkHistAnaFemtoPhi.C("$ROOT_FILE_REAL","$ANA_NAME","$MAINCONF_REAL")'
EOF
)
