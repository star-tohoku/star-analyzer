void run_checkHistAnaPhiMesicNucleus(const Char_t* rootFile,
  ...
  gROOT->ProcessLine(TString::Format(".L %s/common/macro/checkHistAnaPhiMesicNucleus.C+", pwd));
  checkHistAnaPhiMesicNucleus(rootFile, anaName, mainconfPath);
}
