// run_anaFemtoPhi4He.C - Wrapper to load lib and call anaFemtoPhi4He
// Usage: root4star -b -q 'run_anaFemtoPhi4He.C("input.list","output.root","0",100)'

void run_anaFemtoPhi4He(const Char_t* inputFile,
                           ...
                           const Char_t* configPath = 0)
{
  ...
  gROOT->ProcessLine(TString::Format(".L %s/analysis/anaFemtoPhi4He.C+", pwd));
  anaFemtoPhi4He(inputFile, outputFile, jobid, nEventsMax, configPath);
}
