// anaFemtoLambda_3He.C - StFemtoMakerLambdaNuclear based Lambda x 3He femtoscopy
// Usage: root4star -b -q 'anaFemtoLambda_3He.C("input.list","output.root","0",-1)'
//        anaFemtoLambda_3He.C("input.list","output.root","0",-1,"config/mainconf/main_auau3p85_anaFemtoLambda_3He.yaml")
// Run from project root: ./script/run_anaFemtoLambda_3He.sh
...
void anaFemtoLambda_3He(const Char_t* inputFile  = "config/picoDstList/auau3p85fxt.list",
                        const Char_t* outputFile = "rootfile/auau3p85fxt_anaFemtoLambda_3He_temp/auau3p85fxt_anaFemtoLambda_3He_temp.root",
