// anaFemtoLambda_d.C - StFemtoMakerLambdaNuclear based Lambda x deuteron femtoscopy
// Usage: root4star -b -q 'anaFemtoLambda_d.C("input.list","output.root","0",-1)'
//        anaFemtoLambda_d.C("input.list","output.root","0",-1,"config/mainconf/main_auau3p85_anaFemtoLambda_d.yaml")
// Run from project root: ./script/run_anaFemtoLambda_d.sh
...
void anaFemtoLambda_d(const Char_t* inputFile  = "config/picoDstList/auau3p85fxt.list",
                      const Char_t* outputFile = "rootfile/auau3p85fxt_anaFemtoLambda_d_temp/auau3p85fxt_anaFemtoLambda_d_temp.root",
