// anaNuclearId.C - StChain based phi analysis macro
// Usage: root4star -b -q 'anaNuclearId.C("input.list","output.root","0",-1)'
//        anaNuclearId.C("input.list","output.root","0",-1,"config/mainconf/main_auau19_anaNuclearId.yaml")
// Run from project root: ./script/run_anaNuclearId.sh
// ACLiC (.L anaNuclearId.C+) links against libStNuclearIdMaker for StNuclearIdMaker
...
void anaNuclearId(const Char_t* inputFile = "config/picoDstList/auau19GeV.list",
            const Char_t* outputFile = "rootfile/auau19_anaNuclearId_temp/auau19_anaNuclearId_temp.root",
            ...
            const Char_t* configPath = 0)
{
  ...
  // `run_anaNuclearId.C` loads the STAR/Pico/Maker libraries before ACLiC-compiling
