// anaFemtoLambda_t.C - StFemtoMakerLambdaNuclear based Lambda x triton femtoscopy
// Usage: root4star -b -q 'anaFemtoLambda_t.C("input.list","output.root","0",-1)'
//        anaFemtoLambda_t.C("input.list","output.root","0",-1,"config/mainconf/main_auau3p85_anaFemtoLambda_t.yaml")
// Run from project root: ./script/run_anaFemtoLambda_t.sh
...
void anaFemtoLambda_t(const Char_t* inputFile  = "config/picoDstList/auau3p85fxt.list",
                      const Char_t* outputFile = "rootfile/auau3p85fxt_anaFemtoLambda_t_temp/auau3p85fxt_anaFemtoLambda_t_temp.root",
