// anaFemtoPhiProton.C - StChain based phi-p femtoscopy with StFemtoMaker
// Usage: root4star -b -q 'anaFemtoPhiProton.C("input.list","output.root","0",-1)'
// Run from project root: ./script/run_anaFemtoPhiProton.sh
...
void anaFemtoPhiProton(const Char_t* inputFile = "config/picoDstList/auau19GeV.list",
                       const Char_t* outputFile = "rootfile/auau3p85fxt_anaFemtoPhiProton_temp/auau3p85fxt_anaFemtoPhiProton_temp.root",
